...
var aTotalPassedZeros = DoPuzzle();
Console.WriteLine($"Total passed Zeros: {aTotalPassedZeros}");

int DoTest()
{
    var aLock = new Lock();
    aLock.SetPosition(50);

    var aKeyCodes = new List<string>()
    {
        "L68",
        "L30",
        "R48",
    ...
    var aPassedZeros = 0;
    foreach(var aCode in aKeyCodes)
    {
        Console.Write($"Current: {aLock.CurrentPosition} - {aCode} - ");
        var aCurrentPassedZeros = aLock.Turn(aCode);
        aPassedZeros += aCurrentPassedZeros;
        Console.WriteLine($"New: {aLock.CurrentPosition} - Passed Zeros: {aCurrentPassedZeros}");
    }
...
//var aCode = DoPuzzle();
//Console.WriteLine($"The code is: {aCode}");
...
int DoPuzzle()
{
    ...
    {
        aZeroCounts += aLock.Turn(aKeyCode);
    }
...
public class Lock
{
    ...
    public int SetPosition(int aPosition)
    {
